...
#3 - Show added to cart products of user. (not saved if logged off) --DONE
#4 - make addToCart with user (addToCart -> isLoggedIn = false -> send to AccoutPage) --DONE
#5 - make purchase API --DONE
